...
# Working Directory
wDir = '/home/sez26/TIGP-IIP/Learning/Test_lmp_atomsk_lattice_export/'

# importing lmp file
# specifying path to file
LAMP_FILE = wDir + 'NiTi_test.lmp'
b2NiTi = lammpsdata.read_lammps_data(LAMP_FILE)
...
if sum(HEA_II_prop_check) == len(HEA_AtNum):
    ...
    save_name = wDir+'HEA_II.lmp'
    lammpsdata.write_lammps_data(save_name, HEA_ordered, specorder=spec_order)
