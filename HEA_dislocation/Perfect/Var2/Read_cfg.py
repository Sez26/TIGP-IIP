...
# config.read('./min_dump.cfg')
# not standard .ini format therefore normal parser doesn't work
...
# Usage example
parser = LAMMPS_OP_CFGParser('./HEA_dislocation/Perfect/Var2/min_dump.cfg')
